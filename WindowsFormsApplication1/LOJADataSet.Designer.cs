...
#pragma warning disable 1591
    ...
    public partial class LOJADataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClienteRow AddClienteRow(string CPF, string Nome, string Telefone) {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([CPF] = @Original_CPF) AND ([Nome] = @Origina" +
                                                      "l_Nome) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Ori" +
                                                      "ginal_Telefone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([CPF], [Nome], [Telefone]) VALUES (@CPF, @Nome, @Tel" +
                                                      "efone);\r\nSELECT CPF, Nome, Telefone FROM Cliente WHERE (CPF = @CPF)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [CPF] = @CPF, [Nome] = @Nome, [Telefone] = @Telefone WHERE (([CPF] = @Original_CPF) AND ([Nome] = @Original_Nome) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT CPF, Nome, Telefone FROM Cliente WHERE (CPF = @CPF)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CadCliente.Properties.Settings.Default.LOJAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CPF, Nome, Telefone FROM dbo.Cliente";
        ...
        public virtual int Delete(string Original_CPF, string Original_Nome, string Original_Telefone) {
        ...
        public virtual int Insert(string CPF, string Nome, string Telefone) {
            if ((CPF == null)) {
        ...
        public virtual int Update(string CPF, string Nome, string Telefone, string Original_CPF, string Original_Nome, string Original_Telefone) {
            if ((CPF == null)) {
                throw new global::System.ArgumentNullException("CPF");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Telefone, string Original_CPF, string Original_Nome, string Original_Telefone) {
            return this.Update(Original_CPF, Nome, Telefone, Original_CPF, Original_Nome, Original_Telefone);
        }
    }
